...
// Skeleton Loader (mobile responsive)
const Skeleton = () => (
  <div className="min-w-[220px] sm:min-w-[260px] md:min-w-[300px] bg-zinc-100 overflow-hidden animate-pulse rounded-2xl border border-zinc-300">
...
const Accessories = () => {
  ...
  const scroll = (dir) =>
    scrollRef.current?.scrollBy({
      left: dir === "left" ? -320 : 320, // mobile-friendly scroll speed
      behavior: "smooth",
    });
  ...
  return (
    <div className="max-w-7xl mx-auto py-6 sm:py-8 px-3 sm:px-0 bg-white text-zinc-950">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 sm:gap-0 mb-8 sm:mb-10 py-4 sm:py-6 px-3 sm:px-4 rounded-2xl bg-gradient-to-r from-zinc-100/70 via-zinc-500 to-zinc-700">
        <div>
          <p className="text-[9px] sm:text-[10px] font-medium text-zinc-400 tracking-[0.2em] uppercase mb-1 sm:mb-2">
            Exclusive Line
          </p>
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-light tracking-tight text-zinc-900">
            Accessorize Your Vibe
          </h2>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <div className="hidden sm:block w-[1px] h-8 bg-zinc-300 mx-2" />
