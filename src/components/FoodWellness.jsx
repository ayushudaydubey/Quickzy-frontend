  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex items-end justify-between mb-6 mt-4">
        <h2 className="text-3xl font-bold text-zinc-950 text-left">Food & Wellness</h2>
        <button
          onClick={() => navigate('/product?category=Food%20%26%20Wellness')}
