...
// Skeleton Loader (same modern style)
const Skeleton = () => (
  <div className="min-w-[300px] bg-zinc-100 overflow-hidden animate-pulse rounded-2xl border border-zinc-300">
...
// Navigation Button (animated shimmer + hover)
    ...
    <div className="max-w-7xl mx-auto py-8 bg-white text-zinc-950">
      ...
      <div className="flex items-end justify-between mb-10 py-6 px-4 rounded-2xl  bg-gradient-to-r from-zinc-100/70 via-zinc-500 to-zinc-700">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="w-[1px] h-8 bg-zinc-300 mx-2" />
          <button
