...
const Technology = () => {
  ...
  const scroll = (dir) =>
    scrollRef.current?.scrollBy({
      left: dir === "left" ? -320 : 320, // mobile friendly (same as Cards)
      behavior: "smooth",
    });
  ...
  return (
    <div className="max-w-7xl mx-auto py-6 sm:py-8 px-3 sm:px-0 bg-white text-zinc-950">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 sm:gap-0 mb-8 sm:mb-10 py-4 sm:py-6 px-3 sm:px-4 rounded-2xl bg-gradient-to-r from-zinc-100/70 via-zinc-500 to-zinc-700">
        ...
        <div>
          <p className="text-[9px] sm:text-[10px] font-medium text-zinc-500 tracking-[0.2em] uppercase mb-1 sm:mb-2">
            Curated Selection
          </p>
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <button
            ...
            className="relative px-4 sm:px-6 py-2 bg-gradient-to-r from-zinc-900 via-zinc-800 to-black text-white text-[10px] sm:text-[11px] font-medium tracking-[0.15em] uppercase rounded-full transition-all duration-500 shadow-sm hover:shadow-xl overflow-hidden group"
          >
